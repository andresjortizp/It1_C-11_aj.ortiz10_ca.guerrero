...
public class ParranderosTransactionManager {
	...
	public void addBebedorWithLimitations(Bebedor bebedor) throws Exception 
	{
		...
		try
		{
			...
			if(daoBebedor.getBebedoresByCiudadAndPresupuesto(bebedor.getCiudad(), bebedor.getPresupuesto()).size() <= CANTIDAD_MAXIMA)
			{ daoBebedor.addBebedor(bebedor);}
			else
			{throw new Exception("Ya se ha superado el numero maximo de bebedores en " + bebedor.getCiudad());}
		}
		catch (SQLException sqlException) {
			System.err.println("[EXCEPTION] SQLException:" + sqlException.getMessage());
			sqlException.printStackTrace();
	...
	public void updateBebedor(Bebedor bebedor) throws Exception 
	{
		...
		try
		{
			...
			{throw new Exception("El bebedor con el ID " + bebedor.getId() + " no se encuentra en la base de datos");}
		}
		catch (SQLException sqlException) {
			System.err.println("[EXCEPTION] SQLException:" + sqlException.getMessage());
			sqlException.printStackTrace();
	...
	public void deleteBebedor(Bebedor bebedor) throws Exception 
	{
		...
		try
		{
			...
			{throw new Exception("El bebedor con ID " + bebedor.getId() + " no se encuentra en la base de datos");}
		}
		catch (SQLException sqlException) {
			System.err.println("[EXCEPTION] SQLException:" + sqlException.getMessage());
			sqlException.printStackTrace();
