...
public class ServiciosDeAlojamiento {
	 ...
	 */
	public ServiciosDeAlojamiento(@JsonProperty(value="idServicio") Long idServicio, @JsonProperty(value="idOfertaAlojamiento") Long idOfertaAlojamiento) {
